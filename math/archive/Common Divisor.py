...
f_practice = open("Common_divisor.txt", mode="w+", encoding="utf-8")
f_answer = open("Common_divisor_ans.txt", mode="w+", encoding="utf-8")
count = 100
i =  1
...
while i < count:
    ...
    f_practice.write("{}. {}和{}的最大公约数_______      ".format(i, one,two))
    f_answer.write("{}. {};  ".format(i,divisor))
    if i % 2 == 0:
        f_practice.write("\n")
    if i % 10 == 0:
        f_answer.write("\n")
